    ...
    <div className="flex items-center gap-3 text-xs">
      ...
      {showInput ? (
        <div className="flex items-center gap-2 animate-fadeIn">
          <input
            autoFocus
            aria-label="Paste token mint address"
            value={mintInput}
          ...
          <button
            ...
            className="px-2 py-2 text-term-dim hover:text-term-red focus-visible:ring-1 focus-visible:ring-term-red focus-visible:outline-none transition-colors duration-200"
            title="Cancel"
          >
            ✕
          </button>
